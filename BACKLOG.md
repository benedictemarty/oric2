...
| ID | Titre | Estim. | Pré-req |
|----|-------|--------|---------|
| ⚙️ **OS-2.j** | v0.2 (clos 2026-05-08) : driver SD bloc + fat_init signature FAT32 + test fonctionnel. Parser complet boot sector + root dir + loader from SD reportés OS-2.j.3+. | 10-15 j | OS-2.j.3 |
