...
| ⚙️ **SP-GPU-3** | v0.2 ✅ (clos 2026-05-09) : `kernel_gfx_{clear,fill_rect,blit,line}` (OricOS) + tests boot étendus (Phosphoric). 539 tests OK. v0.3 reporté : `kernel_gfx_text` (dépend SP-GPU-2 v0.3 font ROM), IRQ-based wait, refactor `kernel_hires2_*` legacy. | SP-GPU-1 ✅, SP-GPU-2 partiel ✅ |
