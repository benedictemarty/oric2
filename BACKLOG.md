...
| ID | Titre | Estim. | Pré-req |
|----|-------|--------|---------|
| ⚙️ **OS-2.j** | v0.1 (clos 2026-05-08) : driver SD bloc + test fonctionnel pixel-perfect (image test → kernel → bank 1). Parser FAT32 + loader from SD reportés OS-2.j.2+. | 10-15 j | OS-2.j.2 |
